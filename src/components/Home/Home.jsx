...
const Home = () => {
  const handleWhatsAppClick = () => {
    window.open("https://wa.me/573001112233?text=¡Hola!%20Quiero%20hacer%20un%20pedido%20🍖", "_blank");
  };

  const handleRappiClick = () => {
    window.open("https://www.rappi.com.co/tiendas/carnes-al-barril", "_blank");
  };
  ...
  return (
    <>
      ...
      <Segment vertical style={styles.darkSection} className="fade-in-section fade-in-delay-2">
        <Container text textAlign="center">
          <Header as="h2" style={styles.headerLight}>
            Tradición, fuego y sabor artesanal
          </Header>
          <p style={styles.textLight}>
            En <b>Carnes al Barril</b> combinamos el arte del fuego con la mejor selección
            de cortes para ofrecerte una experiencia única.  
            ¡Ven a probar el sabor que nos hace auténticos!
          </p>

          <div style={{ marginTop: "3em" }}>
            <Button size="large" className="pulse-btn" style={styles.orangeButton} onClick={handleWhatsAppClick}>
              WhatsApp
            </Button>
            <Button size="large" className="pulse-btn" style={styles.orangeButton} onClick={handleRappiClick}>
              ¡Pide por Rappi!
            </Button>
          </div>
        </Container>
      ...
      <Divider style={styles.whiteDivider} className="fade-in-section fade-in-delay-3" />

      <Segment vertical style={styles.reviewSection} className="fade-in-section fade-in-delay-3">
        <Container>
          ...
          <Grid stackable columns={3} textAlign="center" style={{ marginTop: "2em" }}>
            {[
              ...
              <Grid.Column key={index} className="card-hover fade-in-section fade-in-delay-3" style={styles.reviewCard}>
