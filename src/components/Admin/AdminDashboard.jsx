...
const AdminDashboard = () => {
  ...
  const handleReservationSubmit = () => {
    ...
    if (editingReservation) {
      updateReservation(editingReservation.id, reservationForm);
    } else {
  ...
  const handleDeleteReservation = (id) => {
    if (window.confirm(t("admin.confirmDeleteReservation"))) {
  ...
  const handleDeleteSuggestion = (id) => {
    if (window.confirm(t("admin.confirmDeleteSuggestion"))) {
      deleteSuggestion(id);
    }
  };
